...
int main()
{
    ...
    executar_testes_45(Diretorio_entrada_crescente, Diretorio_saida_45_crescente, "Crescente");
    executar_testes_45(Diretorio_entrada_decrescente, Diretorio_saida_45_decrescente, "Decrescente");
    executar_testes_45(Diretorio_entrada_aleatorio, Diretorio_saida_45_aleatorio, "Aleatório");
